...
<head>
<?=CONTENTTYPE;?>
<title>Listings Performance</title>
<?=$styles?>
<?=$javascripts?>
        ...
        <div class="col-sm-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <h4>This view lets you compare listings by performance.</h4>
<p>You can change the sort order by clicking column headers.</p>
              <div class="adv-table">
                 <input type="submit" class="btn btn-info" value="Override"> 
                 <span class="export-b">
                 <input type="submit" class="btn btn-info" value="Stock"> 
				 </span> 
				 
				 <span class="export-b">
                 <input type="submit" class="btn btn-info" value="Sources" data-toggle="dropdown" aria-expanded="false">
