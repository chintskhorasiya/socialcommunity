...
<tr>
	<td>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td><p style="font-family:Verdana, Arial, Helvetica, sans-serif; text-align:left; font-size:12px; padding-bottom:10px; margin:0;"><h4>Sorry your Store '.$user_data['store_name'].' is not confirmed with purchasekaro.com/h4></p></td>
			</tr>
			<tr>
