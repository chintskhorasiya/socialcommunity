...
<tr>
	<td>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<th style="color:#12AFE3; text-align:left; font-size:17px; font-weight:bold; font-family:Verdana, Arial, Helvetica, sans-serif; padding:10px 0;">Approval status of your product "'.$product_name.'"</th>
			</tr>
			<tr>
			...
			<tr>
				<td><p style="font-family:Verdana, Arial, Helvetica, sans-serif; text-align:left; font-size:12px; padding-bottom:10px; margin:0;">Your product is rejected by admin. Kindly contact administrator for more information on support@purchasekaro.in</p></td>
			</tr>
			<tr>
				<td height="10"></td>
			</tr>
