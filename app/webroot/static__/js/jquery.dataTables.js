...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * menu (sizes are 100, 250, 500 and 300). Requires pagination (bPaginate).
		 *  @type boolean
		 *  @default true
		 *  @dtopt Features
		 * 
		...
		"oLanguage": {
			 ...
			 * with a default select list of 100, 250, 500 and 1000, and can be replaced
