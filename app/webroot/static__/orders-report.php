        ...
        <div class="col-sm-12">
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="adv-table">
			     <span class="export-b">
                 <input type="submit" class="btn btn-info" value="Manage AO Accounts ↗"> 
                 </span> 
				  
				  <span class="export-b">
                 <input type="submit" class="btn btn-info" value="All Sources" data-toggle="dropdown" aria-expanded="false">
				 ...
				 <span class="export-b">
                 <input type="submit" class="btn btn-info" value="All Orders" data-toggle="dropdown" aria-expanded="false">
                 <span class="caret" data-toggle="dropdown" aria-expanded="false"></span>
                          <ul class="dropdown-menu">
				 ...
				 <input type="submit" class="btn btn-info" value="February 17, 2017 - February 18, 2017" data-toggle="dropdown" aria-expanded="false">
                 <span class="caret" data-toggle="dropdown" aria-expanded="false"></span>
                          <ul class="dropdown-menu">
				 ...
				 <span class="export-b">
                 <input type="submit" class="btn btn-info" value="Has Tracking"> 
                 </span> 
				
				  <span class="export-b">
                 <input type="submit" class="btn btn-info" value="No Tracking"> 
                 </span>
				
				<span class="export-b">
                 <input type="submit" class="btn btn-info" value="Retry Orders">
                 <span class="caret" data-toggle="dropdown" aria-expanded="false"></span>
                          <ul class="dropdown-menu">
                            <li><a href="#">Using random fulfillment account</a></li>
                          </ul>
                </span>
