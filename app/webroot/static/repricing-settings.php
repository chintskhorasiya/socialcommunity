...
<head>
<?=CONTENTTYPE;?>
<title>Repricing Settings</title>
<?=$styles?>
<?=$javascripts?>
...
<section id="container"> 
  ...
  <section id="main-content">
    <section class="wrapper">
      <div class="row">
        <div class="col-lg-12">		  <h1>Repricing Settings</h1>
              ...
              <div class="position-center">
                <form  role="form" action="#" method="post" enctype="multipart/form-data" id="coupon_validate">
                  ...
                  <div class="form-group col-md-6 padding-left-o">
                    ...
                    <div class="input-group"> 
					<input type="number" class="form-control validate required" name="coupon_name" value="<?=$_POST['coupon_name']?>" />
                    <span class="input-group-addon">%</span>
					</div>
				  </div> 
				   <div class="clear"></div>
          ...
          </section>		   				   <section class="panel">             <header class="panel-heading btn-primary">Offer Selection Settings              <span class="h-tooltip" aria-hidden="true">?</span>  						  <div class="tooltip"><span>These settings specify which offers should be considered acceptable. Both repricing and automatic ordering will use the lowest price offer						  that is considered acceptable under these settings.</span>						  </div>			</header>            <div class="panel-body">               <div class="position-center">                <form  role="form" action="#" method="post" enctype="multipart/form-data" id="coupon_validate">                   
				  <div class="clear"></div>
                   <div class="form-group col-md-6 padding-left-o">
