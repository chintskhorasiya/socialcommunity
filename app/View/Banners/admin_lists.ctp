                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of Banners created by you.</p>

                            <?php
                            echo $this->Form->create('bannersSearch', array('url' => array('controller' => 'banners', 'action' => 'search')));
                            ...
                            if(isset($banners_data) && count($banners_data)>0) 
                            {
                            ?>
                            ...
                            <div class="adv-table">
                                ...
                                echo $this->Form->create('bannersList',array('url' => array('controller' => 'banners', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Banners">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($banners_data) && count($banners_data)>0) 
                                        {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="banners_checks[]" value ="<?php echo $banners_data[$i]['Banner']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $banners_data[$i]['Banner']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $banners_data[$i]['Banner']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($banners_data[$i]['Banner']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'banners/edit/adId:'.$banners_data[$i]['Banner']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'banners/delete/adId:'.$banners_data[$i]['Banner']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
