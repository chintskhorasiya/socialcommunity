                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Edit News & Event</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    <?php
                                    echo $this->Form->create('Newsevent', array('novalidate', 'type'=>'file'));
                                    
                                    echo $this->Form->input('title', array('class' => 'form-control input-lg', 'value' => $newsevents_data['Newsevent']['title']));

                                    echo $this->Form->input('source', array('type' => 'file', 'label'=>'Image'));

                                    $add_images = $newsevents_data['Newsevent']['source'];
                                    ...
                                    {   
                                        ...
                                        foreach ($add_images as $add_img_num => $add_img) {
                                            ...
                                            echo '<img src="'.DEFAULT_NEWSEVENTS_IMAGE_URL.'thumb_'.$add_img.'" width="100" height="100" />&nbsp;&nbsp;&nbsp;';
                                            echo '<input type="hidden" name="data[Newsevent][add_image][]" value="'.$add_img.'" />';
                                    ...
                                    echo $this->Form->input('page', array('label' => 'Details','class' => 'form-control input-lg', 'value' => $newsevents_data['Newsevent']['page']));
