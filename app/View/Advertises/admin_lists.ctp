                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of Advertises created by you.</p>

                            <?php
                            echo $this->Form->create('adsSearch', array('url' => array('controller' => 'advertises', 'action' => 'search')));
                            ...
                            <div class="adv-table">
                                ...
                                echo $this->Form->create('advertisesList',array('url' => array('controller' => 'advertises', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Advertises">
                                ...
                                <table class="display table table-bordered table-striped" id="dynamic-table">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($ads_data) && count($ads_data)>0) 
                                        {
                                            for($i=0;$i<count($ads_data);$i++)
                                            {
                                            ?>
                                            <tr class="gradeA">
                                                
                                                <td>
                                                	<input type="checkbox" name="ads_checks[]" value ="<?php echo $ads_data[$i]['Advertise']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $ads_data[$i]['Advertise']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $ads_data[$i]['Advertise']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($ads_data[$i]['Advertise']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'advertises/edit/adId:'.$ads_data[$i]['Advertise']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'advertises/delete/adId:'.$ads_data[$i]['Advertise']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
