                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <div class="adv-table">
                                ...
                                echo $this->Form->create('blogsSearch', array('url' => array('controller' => 'blogs', 'action' => 'search')));
                                ...
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Blogs">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="blogs_checks[]" value ="<?php echo $blogs[$i]['Blogs']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $blogs[$i]['Blogs']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $blogs[$i]['Blogs']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($blogs[$i]['Blogs']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'blogs/edit/blogsId:'.$blogs[$i]['Blogs']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'blogs/delete/blogsId:'.$blogs[$i]['Blogs']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
