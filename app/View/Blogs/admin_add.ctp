<section id="container">
    ...
    <section id="main-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Add Blogs</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    <?php
                                    echo $this->Form->create('Blogs', array('novalidate', 'type'=>'file'));
                                    ...
                                    echo $this->Tinymce->input('Blogs.content', array(
                                                'label' => 'Content',
                                    ...
                                    <div class="form-group col-md-12 padding-left-o">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="data[Blogs][status]" class="form-control-radio" value="1" <?php if($blogs_data['Blogs']['status'] == "1"){ echo 'checked="checked"'; } ?> />Published
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="data[Blogs][status]" class="form-control-radio" value="0" <?php if($blogs_data['Blogs']['status'] == "0"){ echo 'checked="checked"'; } ?> />Draft
                                            </label>
                                        </div>
                                    </div>
        ...
        jQuery('.add-video-btn').click(function(){
            ...
            jQuery(this).before('<div class="col-md-12 you-video-area"><input type="text" name="data[Blogs][videos][]" class="form-control" value="" placeholder="Paste Video URL here" /><input type="button" class="remove-video-btn btn btn-info" value="Remove"></div>');
        })
        jQuery(function(){
