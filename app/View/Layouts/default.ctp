...
<html>
    <head>
        ...
        <!-- //Web-Fonts -->
        <?php if($front){ ?>
            <?php echo $this->Html->css(array('bootstrap','frontstyle', 'lsb', 'font-awesome.css','flexslider')); ?>
            <?php echo $this->Html->script(array('jquery-2.2.3.min','bootstrap','lsb.min','responsiveslides.min','jquery.flexslider','SmoothScroll.min','move-top','easing', 'moment-with-locales','bootstrap-datetimepicker')); ?>
            <?php
