                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of Products Categories.</p>
                            <div class="adv-table">
                                <?php
                                /*echo $this->Html->link(
                                    'Add Category',
                                    '/admin/productscategories/add',
                                    array('class' => 'btn btn-info btn-submit')
                                );*/

                                echo $this->Form->create('productscateSearch', array('url' => array('controller' => 'productscategories', 'action' => 'search')));
                                ...
                                {
                                echo $this->Form->create('productscategoriesList',array('url' => array('controller' => 'productscategories', 'action' => 'delete_selected')));
                                ?>
                                    ...
                                    <tbody>
                                        ...
                                        //print_r($categories);exit;
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <!--<td>
                                                	<input type="checkbox" name="cat_checks[]" value ="<?php echo $categories[$i]['ProductsCategory']['id']; ?>">
                                                </td>-->
                                                
                                                <td class="align-center">
                                                	<?php echo $categories[$i]['ProductsCategory']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $categories[$i]['ProductsCategory']['name']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($categories[$i]['ProductsCategory']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'productscategories/edit/catId:'.$categories[$i]['ProductsCategory']['id'];?>" class="btn btn-default">Edit</a>
                                                    <!--|
                                                    <a href="<?php echo DEFAULT_ADMINURL.'productscategories/delete/catId:'.$categories[$i]['ProductsCategory']['id'];?>" class="btn btn-default btn-delete">Delete</a>-->
                                                </td>
                                            </tr>
                                            <?php
                                            }
