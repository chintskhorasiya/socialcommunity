                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            if(isset($members_data) && count($members_data)>0) 
                            {
                            ?>
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($members_data) && count($members_data)>0) 
                                        {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="Members_checks[]" value ="<?php echo $members_data[$i]['Member']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $members_data[$i]['Member']['created']?>
                                                </td>
