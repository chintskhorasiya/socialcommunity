                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <p>List of Clients created by you.</p>

                            <?php
                            echo $this->Form->create('adsSearch', array('url' => array('controller' => 'clients', 'action' => 'search')));
                            ...
                            if(isset($clients_data) && count($clients_data)>0) 
                            {
                            ?>
                            ...
                            <div class="adv-table">
                                ...
                                echo $this->Form->create('clientsList',array('url' => array('controller' => 'clients', 'action' => 'delete_selected')));
                                ?>
                                <input type="submit" class="btn btn-info btn-delete" value="Delete Selected Clients">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($clients_data) && count($clients_data)>0) 
                                        {
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                	<input type="checkbox" name="ads_checks[]" value ="<?php echo $clients_data[$i]['Client']['id']; ?>">
                                                </td>
                                                
                                                <td class="align-center">
                                                	<?php echo $clients_data[$i]['Client']['created']?>
                                                </td>
                                                
                                                <td>
                                                    <div class="btn-group zn-listing-link">
                                                        <?php echo $clients_data[$i]['Client']['title']; ?>
                                                    </div>
                                                </td>

                                                <td>
                                                	<?php
                                                    if($clients_data[$i]['Client']['status']=='1'){
                                                        ?>
                                                ...
                                                <td> 
                                                    <a href="<?php echo DEFAULT_ADMINURL.'clients/edit/adId:'.$clients_data[$i]['Client']['id'];?>" class="btn btn-default">Edit</a>
                                                    |
                                                    <a href="<?php echo DEFAULT_ADMINURL.'clients/delete/adId:'.$clients_data[$i]['Client']['id'];?>" class="btn btn-default btn-delete">Delete</a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
