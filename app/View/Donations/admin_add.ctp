                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <section class="panel  border-o">
                            <header class="panel-heading btn-primary">Add Donor</header>
                            <div class="panel-body">
                                <div class="position-center">
                                    ...
                                    echo $this->Form->input('address', array('class' => 'form-control input-lg'));
                                    echo $this->Form->input('phone', array('class' => 'form-control input-lg'));
                                    echo $this->Form->input('amount', array('class' => 'form-control input-lg'));
